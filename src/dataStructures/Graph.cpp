 ...
 *
 * The function deletes all the vertices in the graph and clears the vertex set.
 */
 ...
 *
 * COMPLEXITY: O((V+E) * log(V)), where V is the number of vertices in the graph and E the number of edges.
 *
